...
<input type="text"  readonly='true'name="TPusername-txt" value="<?php echo $info['username']; ?>" size="50" />

<h5>Password</h5>
<label style="color:red"><?php echo form_error('TPpassword-txt'); ?></label>
<input type="text" name="TPpassword-txt" value="<?php echo $info['password']; ?>" size="50" />

<h5>Repeat Password</h5>
<label style="color:red"><?php echo form_error('TPpassword2-txt'); ?></label>
<input type="text" name="TPpassword2-txt" value="<?php echo $info['password']; ?>" size="50" />

<h5>First Name</h5>
<label style="color:red"><?php echo form_error('TPfirstname-txt'); ?></label>
<input type="text"  name="TPfirstname-txt" value="<?php echo $info['firstname']; ?>" size="50" />

<h5>Middle Name</h5>
<label style="color:red"><?php echo form_error('TPmiddlename-txt'); ?></label>
<input type="text"   name="TPmiddlename-txt" value="<?php echo $info['middlename']; ?>" size="50" />

<h5>Last Name</h5>
<label style="color:red"><?php echo form_error('TPlastname-txt'); ?></label>
<input type="text"  name="TPlastname-txt" value="<?php echo $info['lastname']; ?>" size="50" />
