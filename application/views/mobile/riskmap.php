...
<script>
	...
	<input type="hidden" id="computation_length" value="<?= count($distance_formula_200) ?>" />
	<!-- 200m -->
	<?php for ($i = 0; $i < count($distance_formula_200); $i++) :?>
	<input type="hidden" id="tracking_no_200_<?= $i ?>"	value="<?php echo $distance_formula_200[$i]['tracking_no'];?>" /> <br/>
	<input type="hidden" id="amount_200_<?= $i ?>" 		value="<?php echo $distance_formula_200[$i]['amount'];?>" /> <br/>
	<input type="hidden" id="percentage_200_<?= $i ?>"	value="<?php echo $distance_formula_200[$i]['percentage'];?>" /> <br/>
	<?php endfor;?>
	<!-- /200m -->
	
	<!-- 50m -->
	<?php for ($i = 0; $i < count($distance_formula_50); $i++) :?>
	<input type="hidden" id="tracking_no_50_<?= $i ?>"	value="<?php echo $distance_formula_50[$i]['tracking_no'];?>" /> <br/>
	<input type="hidden" id="amount_50_<?= $i ?>" 		value="<?php echo $distance_formula_50[$i]['amount'];?>" /> <br/>
	<input type="hidden" id="percentage_50_<?= $i ?>"	value="<?php echo $distance_formula_50[$i]['percentage'];?>" /> <br/>
	<?php endfor;?>
	<!-- /50m -->
